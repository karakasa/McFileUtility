...
namespace McFileIo.World
{
    ...
    /// </summary>
    public abstract class LowLevelChunk : INbtFileSnapshot
    {
        ...
        public bool TryGetBlockEntityByWorldCoord(int x, int y, int z, out BlockEntity entity)
        {
            EnsureBlockEntities();
        ...
        public static LowLevelChunk CreateFromBytes(byte[] buffer, int offset = 0, int length = 0,
